#include "autoware_roi_points_fusion/roi_points_fusion_visualizer_node.hpp"
...
: Node("roi_points_fusion_visualizer_node", node_options),
  image_sub_(this, "~/in/image", rclcpp::QoS(10).get_rmw_qos_profile()),
  roi_sub_(this, "~/in/rois", rclcpp::QoS(10).get_rmw_qos_profile())
{
  ...
  visualizer_pub_ = this->create_publisher<sensor_msgs::msg::Image>("~/out/visualization", 10);
